      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
             <span className="font-serif text-3xl tracking-widest text-brand-500 font-bold mb-4 drop-shadow-sm">BASTA</span>
          ...
          <div className="flex flex-col justify-center items-center text-center">
            ...
            <div className="flex items-start gap-3 text-gray-400 hover:text-brand-400 transition-colors">
              ...
              <div className="max-w-[200px]">
                Mall of Qatar, Rawdat Al Jahhaniya,<br/> Qatar
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex items-center justify-center">
          <p className="text-gray-600 text-sm text-center">
            © {new Date().getFullYear()} BASTA. {t.footer.rights}
          </p>
        </div>
      </div>
    </footer>
